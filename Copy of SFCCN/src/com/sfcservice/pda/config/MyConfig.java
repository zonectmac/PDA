...
public class MyConfig {
	...
	// "http://192.168.1.19/default/svc/author/params/";
	// public static final String URL_COMMON =
	// "http://192.168.1.19/default/svc/svc";
	// public static final String URL_CHECK =
	// "http://192.168.1.19/default/svc/check";
	public static final String URL_PRE = "http://190.168.1.17";
	// public static final String URL_UPDATE =
	// "http://192.168.1.27/moblieapp/android/version.xml";
	// cfftest2
	// chinafulfill
	// public static final String URL_PRE = "http://admin.sfcservice.com";
	// public static final String URL_LOGIN = URL_PRE
	// + "/adminuser/user/author/params/";
	public static final String URL_LOGIN = URL_PRE
			+ "/default/Pdapickup-api/check-login";
	public static final String URL_GET_DELIVERY = URL_PRE
			+ "/default/Pdapickup-api/function-service";
	...
	public static final String URL_CRASHUPLOAD = URL_PRE
			+ "/mobileapp/android/getAppLog.php";

	public static final String URL_UPDATE = URL_PRE
			+ "/mobileapp/android/version.xml";
	...
	public static final String[] SFCHomeItemText = { "取件列表", "收货列表" };
	public static final int[] SFCHomeItemImg = { R.drawable.pickup,
			R.drawable.takeover };
